...
export async function getGeminiResponse(message) {
  ...
  const prompt = `You are a helpful study assistant. Your role is to help students understand concepts, 
  explain topics clearly, and provide guidance on effective study techniques. 
  
  User message: ${message}
  
  Provide a clear, helpful, and concise response. If the question is about a specific academic topic, 
  include relevant examples or analogies to aid understanding.`;
